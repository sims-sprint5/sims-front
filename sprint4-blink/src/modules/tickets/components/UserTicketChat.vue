          ...
          <div
            :class="[
              ...
              isOwnMessage(message)
                ...
                : 'bg-surface border border-purple-200 text-main rounded-tl-sm'
            ]"
          >
    ...
    <div class="border-t pt-3 sm:pt-4 px-4 sm:px-0">
      <form @submit.prevent="handleSubmit" class="space-y-2 sm:space-y-3">
        <textarea
          v-model="newMessage"
          rows="2"
          class="w-full px-3 sm:px-4 py-2 sm:py-3 border border-default rounded-xl transition-all focus:ring-2 focus:ring-primary-500 focus:border-transparent resize-none text-sm"
